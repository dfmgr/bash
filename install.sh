...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Setup plugins
PLUGIN_REPOS="https://github.com/Bash-it/bash-it https://github.com/asdf-vm/asdf https://github.com/basherpm/basher"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Grab release from github releases
LATEST_RELEASE=""
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Specify global packages
GLOBAL_OS_PACKAGES="bash "
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
__run_prepost_install() {
  ...
  [ -d "$HOME/.config/bash" ] || __mkdir "$HOME/.config/bash"
  [ -f "$HOME/.config/bash/bash_history" ] && __mv_f "$HOME/.config/bash/bash_history" "/tmp/bash_history.tmp"
...
__run_post_install() {
  ...
  [ ! -f "$APPDIR/bashrc" ] || __symlink "$APPDIR/bashrc" "$HOME/.bashrc"
